...
/*
    public void SaveButtonClick(View view){
        ...
        Intent saveGesture = new Intent(this,GestureListActivity.class);
        startActivity(saveGesture);
    }

    public void DoneButtonClick(View view){
        Intent testGesture = new Intent(this, GestureListActivity.class);
...
*/
    ...
    private void getName() {
        ...
        namePopup.setTitle("Select Number: ");
        //namePopup.setMessage(R.string.enter_name);

        final String[] dinner = {"1","2","3","4","5","6","7","8","9"};
        final EditText nameField = new EditText(this);
        namePopup.setItems(dinner, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {


                    mGesturename = dinner[i];
                    showToast("you select" +mGesturename );
                    saveGesture();
