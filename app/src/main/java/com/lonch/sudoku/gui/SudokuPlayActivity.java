...
import com.lonch.sudoku.db.SudokuDatabase;
import com.lonch.sudoku.game.Cell;
import com.lonch.sudoku.game.SudokuGame;
import com.lonch.sudoku.game.SudokuGame.OnPuzzleSolvedListener;
import com.lonch.sudoku.gui.inputmethod.IMControlPanel;
import com.lonch.sudoku.gui.inputmethod.IMControlPanelStatePersister;
import com.lonch.sudoku.gui.inputmethod.IMNumpad;
import com.lonch.sudoku.gui.inputmethod.IMPopup;
import com.lonch.sudoku.gui.inputmethod.IMSingleNumber;
import com.lonch.sudoku.utils.AndroidUtils;
...
/*
		mSudokuBoard.setdigitfontsize(gameSettings.getInt("fontsize", 3));
		mSudokuBoard.setdigitfontstyle(gameSettings.getInt("fontstyle",0));
*/
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			...
			case MENU_ITEM_CLEAR_ALL_NOTES:
				...
				i8.setClass(this, GestureListActivity.class);
				startActivity(i8);
