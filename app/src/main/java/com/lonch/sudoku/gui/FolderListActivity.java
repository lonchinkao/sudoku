...
import com.lonch.sudoku.db.FolderColumns;
import com.lonch.sudoku.db.SudokuDatabase;
import com.lonch.sudoku.game.FolderInfo;
import com.lonch.sudoku.gui.FolderDetailLoader.FolderDetailCallback;
...
public class FolderListActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View getScanorc = (View) findViewById(R.id.scan_orc);
		getScanorc.setOnClickListener(new OnClickListener() {
			@Override
